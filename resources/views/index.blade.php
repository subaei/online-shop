                        ...
                        <div class="slider-single-item">
                            ...
                            <article class="list-product text-center">
                                <div class="product-inner">
                                    ...
                                    <div class="product-decs">
                                        <a wire:navigate class="inner-link" href="/shop"><span>STUDIO DESIGN</span></a>
                                        <h2><a wire:navigate href="single-product.html" class="product-link">Madden by Steve Madden</a></h2>
                                        <div class="pricing-meta">
                                            <ul>
                                                <li class="current-price">$21.51</li>
                                            </ul>
            ...
            <div class="popular-category-slider-wrapper slider-nav-style-1 slider-nav-style-2 ">
                ...
                <div class="single-slider-item">
                    ...
                    <div class="category-discript">
                        <h4>{{ $category->name }}</h4>
                        <ul>
                            <li><a wire:navigate href="#">Hot Categories</a></li>
                            <li><a wire:navigate href="#">Outerwear & Jackets</a></li>
                            <li><a wire:navigate href="#">Weddings & Events</a></li>
                            <li><a wire:navigate href="#">Bottoms</a></li>
                            <li><a wire:navigate href="#">Tops & Sets</a></li>
                        </ul>
                        <a wire:navigate href="/categories" class="view-all-btn">View All</a>
                    </div>
                </div>
                <!-- single-item -->
                @endforeach
