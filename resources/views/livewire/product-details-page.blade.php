                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="product-details-img product-details-tab">
                        <div class="zoompro-wrap zoompro-2">
                            ...
                            <div class="zoompro-border zoompro-span" wire:key="{{ url('storage', $image) }}">
                                <img class="zoompro" src="{{ url('storage', $image) }}" data-zoom-image="{{ url('storage', $image) }}" alt="{{ $product->name }}" />
                            </div>
                            @endforeach
                        </div>
                        <div id="gallery" class="product-dec-slider-2">
                            @foreach ($product->images as $image)
                            <div class="single-slide-item" wire:key="{{ url('storage', $image) }}" >
                                <img class="img-responsive" data-image="{{ url('storage', $image) }}" data-zoom-image="{{ url('storage', $image) }}" src="{{ url('storage', $image) }}" alt="{{ $product->name }}" />
                            </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="product-details-content">
                        ...
                        <div class="pro-details-quality mt-0px">
                            <div class="my-cart-plus-minus">
                                <div wire:click.prevent='decreaseQty' class="dec qtybutton">-</div>
                                <input wire:model='quantity' class="cart-plus-minus-box" type="text" name="qtybutton" value="{{ $quantity }}" />
                                <div wire:click.prevent='increaseQty' class="inc qtybutton">+</div>
                            </div>
